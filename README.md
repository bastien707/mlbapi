...
## Tests
Pour effectuer nos tests unitaires, nous avons utilisé le framework Munit. Munit est un framework de tests léger, simple à utiliser et hautement expressif, conçu spécifiquement pour Scala et Scala.js. Il offre une syntaxe concise et intuitive pour écrire des tests unitaires, facilitant ainsi le processus de développement et de maintenance du code. De plus, Munit prend en charge la parallélisation des tests, ce qui permet d'accélérer l'exécution des tests sur des machines multicœurs. Grâce à ces fonctionnalités, Munit offre un moyen puissant et efficace d'assurer la qualité du code Scala en détectant rapidement les erreurs et en garantissant le bon fonctionnement des différentes unités de code. Ce qui explique notre choix.